            ...
            <ol class="inline-flex items-center space-x-1 md:space-x-3">
                ...
                <li>
                    <div class="flex items-center">
                        ...
                        <a href="/industries.html" class="hover:text-laravel-red transition duration-300">Industries</a>
                    </div>
                </li>
        ...
        <nav class="flex text-gray-500 text-sm font-medium" aria-label="Breadcrumb">
            <ol class="inline-flex items-center space-x-1 md:space-x-3">
                ...
                <li aria-current="page">
                    <div class="flex items-center">
                        <i class="fas fa-chevron-right text-gray-400 text-xs mx-2"></i>
                        <span class="text-laravel-red font-semibold ml-1 md:ml-2">Industries</span>
                    </div>
                </li>
            </ol>
        </nav>
