                    ...
                    <div class="relative group py-5">
                        ...
                        <div class="absolute left-1/2 -translate-x-1/2 top-full mt-1 w-[440px] bg-white rounded-xl shadow-xl border border-gray-100 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 transform scale-95 group-hover:scale-100 z-50 p-5">
                            <div class="grid grid-cols-2 gap-4">
                                ...
                                <a href="/industry/fintech-and-payments.html" class="flex items-start p-2 rounded-lg hover:bg-gray-50 transition duration-150">
                                    <div class="bg-blue-500/10 text-blue-500 p-2 rounded-md mr-3">
                                        <i class="fas fa-credit-card text-sm"></i>
                                    </div>
                                    <div>
                                        <div class="font-bold text-gray-900 text-sm">FinTech & Payments</div>
                                        <div class="text-xs text-gray-500">Secure transaction gateways.</div>
                                    </div>
                                </a>
                                <a href="/industry/logistics-and-delivery.html" class="flex items-start p-2 rounded-lg hover:bg-gray-50 transition duration-150">
                                    <div class="bg-green-500/10 text-green-500 p-2 rounded-md mr-3">
                                        <i class="fas fa-truck text-sm"></i>
                                    </div>
                                    <div>
                                        <div class="font-bold text-gray-900 text-sm">Logistics & Delivery</div>
                    ...
                    <div class="relative group py-5">
                        ...
                        <div class="absolute left-1/2 -translate-x-1/2 top-full mt-1 w-[440px] bg-white rounded-xl shadow-xl border border-gray-100 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 transform scale-95 group-hover:scale-100 z-50 p-5">
                            <div class="grid grid-cols-2 gap-4">
                                ...
                                <a href="/technology/laravel-framework.html" class="flex items-start p-2 rounded-lg hover:bg-gray-50 transition duration-150">
                                    <div class="bg-laravel-red/10 text-laravel-red p-2 rounded-md mr-3">
                                ...
                                <div class="col-span-2 border-t border-gray-100 pt-3 text-center bg-gray-50 -mx-5 -mb-5 px-5 py-3 rounded-b-xl">
                                    <a href="/technologies.html" class="text-xs font-bold text-laravel-red hover:underline">Explore all 16 frameworks & tools</a>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="px-4 py-4 space-y-2">
                ...
                <div class="space-y-1">
                    ...
                    <div class="mobile-submenu hidden pl-4 space-y-1">
                        ...
                        <a href="/industry/fintech-and-payments.html" class="block px-4 py-2 text-sm text-gray-600 hover:text-laravel-red hover:bg-gray-50 rounded-md">FinTech & Payments</a>
                        <a href="/industry/logistics-and-delivery.html" class="block px-4 py-2 text-sm text-gray-600 hover:text-laravel-red hover:bg-gray-50 rounded-md">Logistics & Delivery</a>
                ...
                <div class="space-y-1">
                    ...
                    <div class="mobile-submenu hidden pl-4 space-y-1">
                        ...
                        <a href="/technology/laravel-framework.html" class="block px-4 py-2 text-sm text-gray-600 hover:text-laravel-red hover:bg-gray-50 rounded-md">Laravel Framework</a>
